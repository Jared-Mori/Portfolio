<script lang="ts">
    ...
    let projects = [
        ...
        { id: 1, title: "Japanese Web", description: "A site hosting a variety of small webgames, focused around learning Japanese. Practice counters, matching vocabulary to everyday objects, and more.", link: "https://japanese-web-app-five.vercel.app", github: "https://github.com/Jared-Mori/JapaneseWebApp.git", tags: ["Svelte", "Full-Stack"] },
